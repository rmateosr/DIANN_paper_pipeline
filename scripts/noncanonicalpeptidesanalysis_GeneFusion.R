...
#   (non_canonical_peptide_headers.txt) but are separated by the ":" character:
...
#
# INPUTS:
#   non_canonical_peptide_headers.txt — all non-canonical peptide headers
#       (from filter_canonical_peptides.sh).
#   gene_fusion_peptide_library.tsv   — predicted fusion-spanning peptides
...
#   fusion_peptides.tsv                      — normalised intensities for detected
#       fusion peptides.
#   gene_fusion_library_presentinanalysis.tsv — subset of the fusion library that
#       matches detected peptides.
#   fusion_by_gene.pdf — one plot per unique fusion pair.
